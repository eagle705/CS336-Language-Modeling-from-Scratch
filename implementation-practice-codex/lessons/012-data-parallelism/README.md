# 012. Data Parallelism

Focus: DDP simulation and gradient accumulation

Source: `implementation-practice/02-mlp-parallelism/data_parallelism.py`
원본 모듈 제목: `Data Parallelism (DP) for MLP`
...
```bash
python implementation-practice-codex/lessons/012-data-parallelism/starter.py
python implementation-practice-codex/lessons/012-data-parallelism/solution.py
```
...
- function `ddp_vs_dp`
- function `simulate_gradient_accumulation`
